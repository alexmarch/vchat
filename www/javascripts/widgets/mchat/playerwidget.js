define(['jquery', 'underscore', 'backbone'], function ($, _, Backbone) {
	var _template = '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="650" height="352" id="VPlay" align="middle">\
		...
		<object type="application/x-shockwave-flash" id="VPlay" data="chat-app/www/assets/src/VPlay.swf" width="650" height="352">\
			...
			<!--[if !IE]>-->\
			<embed src="chat-app/www/assets/src/VPlay.swf" allowFullScreen="true" bgcolor="#000000" width="650" height="352" name="VPlay" align="middle" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />\
		</object>\
		<!--<![endif]-->\
